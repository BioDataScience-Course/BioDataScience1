...
L'association entre deux variables peut être quantifiée grâce à différents descripteurs ou indices comme la covariance, l'indice de corrélation de Pearson, l'indice de de corrélation de Spearman ou de Kendall.
...
La corrélation est simplement l'association de deux variables sans élaborer plus d'hypothèses sur les mécanismes éventuellement responsables de cette association.
...
Réalisez un graphique de votre objet `iris_corr`. N'affichez que la partie supérieur de votre matrice. Tout comme le résumé de la matrice ne montre que la partie inférieure de la matrice, il n'est pas utile de représenter la matrice complète sous forme graphique car la matrice est symétrique autour de sa diagonale.
...
question("La largeur des pétales (petal_width) et la longueur des pétales (petal_length) sont-elles significativement corrélées au seuil alpha de 5% ?",
  ...
  answer("Non"),
  correct = "Avec une valeur P inférieure au seuil alpha, il y a rejet de l'hypothèse nulle.", 
