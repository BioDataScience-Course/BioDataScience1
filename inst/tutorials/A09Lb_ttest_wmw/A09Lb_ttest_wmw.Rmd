...
description: "**SDD I Module 9** Tests t de Student et de Wilcoxon/Mann-Whitney."
tutorial:
  id: "A09Lb_ttest_wmw"
  version: 2.2.0/11
output:
...
quiz(
  question("Rejetez-vous $H_0$ ?",
    ...
    correct = "Bravo, c'est correct. Vous rejetez effectivement $H_0$ au seuil alpha de 5%."),
