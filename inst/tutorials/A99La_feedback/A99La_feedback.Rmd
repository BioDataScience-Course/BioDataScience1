...
question("Quelle partie du cours évaluez-vous ?",
  answer("Module 1 : Introduction & visualisation I", correct = TRUE),
  answer("Module 2 : Visualisation II", correct = TRUE),
  answer("Module 3 : Visualisation III", correct = TRUE),
  answer("Module 4 : Traitement des données I", correct = TRUE),
  answer("Module 5 : Traitement des données II", correct = TRUE),
  answer("**AA visualisation (Q1, modules 1-5)**", correct = TRUE),
  answer("Module 6 : Probabilités, distributions I & corrélation", correct = TRUE),
  answer("Module 7 : Distribution & Test Chi carré", correct = TRUE),
  answer("Module 8 : Moyenne", correct = TRUE),
  answer("Module 9 : Variance I", correct = TRUE),
  answer("Module 10 : Variance II", correct = TRUE),
  answer("**AA inférence (Q2, modules 6-10)**", correct = TRUE),
