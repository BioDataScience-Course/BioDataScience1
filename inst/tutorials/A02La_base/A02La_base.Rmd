...
description: "**SDD I Module 2** Principales opérations et commandes dans R."
tutorial:
  id: "A02a_base"
  version: 2.0.0/7
output: 
...
*S'il est présent, le bouton **Solution** permet de visualiser le code qui est demandé. Essayez toujours de résoudre l'exercice par vous-même.* **_Si vous visualisez la solution, vous perdez automatiquement la moitié des points pour la question\ !_**
